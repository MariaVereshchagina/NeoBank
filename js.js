...
btnLogin.addEventListener("click", function (e) {
  ...
  console.log("btnLogin.addEventListener", currentAccount);
...
btnTransfer.addEventListener("click", function (e) {
  ...
  console.log("btnTransfer.addEventListener", currentAccount);
  if (
    reciveAcc &&
    amount > 0 &&
...
const now = new Date();
const gb = Intl.DateTimeFormat("en-GB").format(now);
console.log(gb);
